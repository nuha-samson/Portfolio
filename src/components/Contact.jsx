...
export default function Contact() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo('.accent-word', { x: 0, y: 10, opacity: 0, color: 'var(--accent)' }, { x: 20, y: 10, opacity: 1, color: 'var(--text)', duration: 0.8, scrollTrigger: { trigger: '.accent-word', start: 'top 85%' } });
